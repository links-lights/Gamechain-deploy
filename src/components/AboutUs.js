  ...
  const us = [
    {
      ...
      imageSrc: Emil,
      about:
        "Hello my Name is Emil. I love web3! I'm a crypto investor and distributed systems builder. I enjoy working endlessly learning new blockchain tech and have great taste in music, according to myself.",
    ...
    <>
      ...
      >
        ...
        {us.map((self, idx) => {
          ...
          return (
            <>
              <Box className={name} gridColumn="span 1" p={6} sx={{}}>
