        ...
        >
          <Paper sx={{ minHeight: "10vw" }} p={4} display="grid">
            <Box p={4}>
              ...
              <Typography variant="body1">
                In order to start the game you will need an ethereum wallet. You
                will need ether in your wallet to pay{" "}
                <Link
                ...
                and receive TZFETokens.
                <br></br>
                <br></br>
                We are currently in Beta Testing. Our smart contract is deployed
                on{" "}
                <Link
                  src="https://ethereum.org/en/developers/docs/networks/#ropsten"
                  underline="hover"
                >
                  Ropsten
                </Link>
                . Please follow these steps in order to play and place on the
                scoreboard.
                <ol>
                  <li>
                    Have{" "}
                    ...
                    installed. Setup your account and wallet.
                  </li>
                  <li>
                    Click on Networks in MetaMask, center top button, and choose
                    Ropsten Test Network.
                  </li>
                  <li>
                    Get free test ethereum by copy/pasting your address into
                    form on{" "}
                    <Link href="https://faucet.ropsten.be/" underline="hover">
                      Ropsten faucet
                    </Link>{" "}
                    and clicking 'Send me Test Ether.' Transaction may take a
                    moment, multiple requests will gray-list you.{" "}
                  </li>
                  <li>
                    Reload webPage and accept connection to MetaMask with your
                    account on Ropsten Network.
                  </li>
          ...
          >
            <Box className="howToPlay" gridColumn="span 9">
              <Typography variant="body1">
                2048 is played on a plain 4×4 grid, with numbered tiles that
                slide when a player moves them using the four arrow keys. Every
                turn, a new tile randomly appears in an empty spot on the board
                with a value of either 2 or 4. Tiles slide as far as possible in
                the chosen direction until they are stopped by either another
                ...
                merge with another tile again in the same move. Higher-scoring
                tiles emit a soft glow; the highest possible tile is 131,072.
                <br></br>
                <br></br>
                If a move causes three consecutive tiles of the same value to
                ...
                row/column will combine the first two and last two. A scoreboard
                on the upper-right keeps track of the user's score. The user's
                score starts at zero, and is increased whenever two tiles
                combine, by the value of the new tile.
                <br></br>
                <br></br>
            ...
            <Box className="2048gif" gridColumn="span 3">
              ...
              <Typography sx={{ fontSize: "12px", alignSelf: "flex-end" }}>
                <Link
                  href="https://gfycat.com/ifr/ElegantSaneKingbird"
                  underline="hover"
                >
                  Gif:Source
                </Link>
